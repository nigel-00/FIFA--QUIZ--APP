...
class MainActivity4 : AppCompatActivity(),View.OnClickListener{
    ...
    var score = 0
    var totalQuestion:Int = QuestionAnswer3.question.size
    ...
    override fun onClick( view: View) {
        ...
        if (clickedButton.id == R.id.submit_btn){
            if ( selectedAnswer == QuestionAnswer3.correctAnswers[currentQuestionIndex]){
                score ++
            }
    ...
    private fun loadNewQuestion() {
        ...
        questionTextView.text = QuestionAnswer3.question[currentQuestionIndex]
        ansA.text = QuestionAnswer3.choices[currentQuestionIndex][0]
        ansB.text = QuestionAnswer3.choices[currentQuestionIndex][1]
        ansC.text = QuestionAnswer3.choices[currentQuestionIndex][2]
        ansD.text = QuestionAnswer3.choices[currentQuestionIndex][3]
    }
