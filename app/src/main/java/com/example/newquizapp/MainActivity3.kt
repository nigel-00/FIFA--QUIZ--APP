...
class MainActivity3 : AppCompatActivity(),View.OnClickListener{
    ...
    var score = 0
    var totalQuestion:Int = QuestionAnswer2.question.size
    ...
    override fun onClick( view: View) {
        ...
        if (clickedButton.id == R.id.submit_btn){
            if ( selectedAnswer == QuestionAnswer2.correctAnswers[currentQuestionIndex]){
                score ++
            }
    ...
    private fun loadNewQuestion() {
        ...
        questionTextView.text = QuestionAnswer2.question[currentQuestionIndex]
        ansA.text = QuestionAnswer2.choices[currentQuestionIndex][0]
        ansB.text = QuestionAnswer2.choices[currentQuestionIndex][1]
        ansC.text = QuestionAnswer2.choices[currentQuestionIndex][2]
        ansD.text = QuestionAnswer2.choices[currentQuestionIndex][3]
    }
